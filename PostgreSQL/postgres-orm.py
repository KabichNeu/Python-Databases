...
class Sales(Base):
    ...
    def __repr__(self):
        return '''
        <Sale(order_num='{0}', order_type'{1}', cust_name='{2}',
        prod_name='{3}', quantity='{4}', order_total='{5}' )>
        '''.format(self.cust_name, self.prod_name, self.quantity, seld.order_total)
...
if __name__ == "__main__":
    ...
    #insert
    recent_sale = Sales(order_num=1105910, order_type='Retail', cust_name='Syman Myan', ..)
    print(recent_sale)
